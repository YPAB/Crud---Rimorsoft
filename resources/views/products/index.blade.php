...
<h2>
	...
	<a href="{{ route('products.create') }}" class="btn btn-primary float-right">JavaScript</a>
</h2>
...
<table class="table table-hover table-striped">	
	...
	<!campo para generar un token, es una funcion que genera un campo oculto. protegemos nuestro sistema->
				{{ csrf_field() }}
